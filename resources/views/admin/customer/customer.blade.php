	...
	<div class="container-fluid"> 
		<div class=" bg-white table-responsive">
		   ...
		   <div class="form-group col-md-1 col-lg-1 col-sm-6 col-xs-12" style="margin:1%">
				<button type="button" class="btn btn-info btn-rounded mb-0-25 waves-effect waves-light" data-toggle="modal" data-target="#add_customer"><b><i class="ti-plus"></i></b> Add</button>
		   </div>
